<template>
  ...
  >
    <div class="text-xl mb-3 mt-3">
      ...
      <br />
      <div
        class="mb-3 py-2 max-w-xs mx-auto shadow-md items-center rounded-xl"
        :class="{
          'bg-red-400': switch_page == 1,
          'bg-green-300': switch_page == 0,
        }"
      >
    ...
    <ul v-for="address in memory_address" v-bind:key="address.physical_address">
      <div
        ...
        :class="{
          'bg-gray-300':
            switch_page == 0 && hit != address.physical_address % 10,
          'bg-green-300':
            switch_page == 0 && hit == address.physical_address % 10,
          'bg-yellow-500': switch_page == 1,
        }"
      >
